  ...
  @02_busca_rapida
  Cenário: Realizar busca rápida por dermatologia que atenda no Rio de Janeiro
  ...
  Então valido as 3 primeiras páginas de resultando não contendo a cidade de São Paulo
